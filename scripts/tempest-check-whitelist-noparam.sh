#!/bin/bash
# tempest-check-whitelist-noparam: invoked via `!include-raw-escape:` from data/builder-macros.yaml.
# SITE, CLOUD, CHECK and WHITELIST are injected as env vars by the macro. No `set`:
